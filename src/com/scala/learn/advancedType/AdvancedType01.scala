...
=======
  ...
  def func04() {
    def appendLines(target: { def append(str: String): Any }, lines: Iterable[String]) {
      for (line <- lines) { target.append(line); target.append("\n") }
>>>>>>> ..
      /*
...
=======
      def set(obj: Title.type): this.type = { useNextArgAs = obj; println("set title"); this }
      def to(arg: String) = if (useNextArgAs == Title) useNextArgAs = arg; else println("...")
>>>>>>> ..
...
=======
      def addChapter(chapter: String): this.type = { println("set author"); this }
      def addContent(content: String): this.type = { println("set content"); this }
>>>>>>> ..
    }
    val book = new Book()
...
=======
      def setTitle(title: String): this.type = { println("set title"); this }
      def setAuthor(author: String): this.type = { println("set author"); this }
>>>>>>> ..
    }
